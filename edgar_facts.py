"""
edgar_facts.py v3 — SEC EDGAR Company Facts endpoint for the Growth Alpha / Consilium Spine microservice.
...
SEC_USER_AGENT = "GrowthAlphaPipeline/1.0 (contact: your-email@example.com)"  # EDIT to your real email
_MIN_INTERVAL = 0.12
_last_call = [0.0]
_CIK_CACHE = {}
_FACTS_CACHE = {}
...
def edgar_facts(ticker=None, cik=None):
    ...
    # C: shares_current cascade (companyfacts dei absent for ASTS -> companyconcept)
